(function(){
  ...
  // k — turkum kaliti (TURKUMLAR ro'yxatiga mos: taom/non/ichimlik/meva/sut/shirinlik)
  var TAOMLAR = [
    {n:"Osh (palov)", e:"🍛", r:"palov", k:"taom", p:[["Kichik kosa",45],["O'rta kosa",65],["Katta kosa",85]]},
    {n:"Lag'mon", e:"🍜", r:"lagmon", k:"taom", p:[["Kichik",40],["O'rta",55],["Katta",70]]},
    {n:"Mastava", e:"🥣", r:"mastava", k:"taom", p:[["Kichik",25],["O'rta",35],["Katta",45]]},
    {n:"Sho'rva", e:"🍲", r:"shorva", k:"taom", p:[["Kichik",20],["O'rta",30],["Katta",40]]},
    {n:"Manti", e:"🥟", r:"manti", k:"taom", p:[["2 dona",26],["4 dona",52],["6 dona",78]]},
    {n:"Somsa", e:"🫓", r:"somsa", k:"taom", p:[["1 dona",28],["2 dona",56],["3 dona",84]]},
    {n:"Chuchvara", e:"🍚", r:"chuchvara", k:"taom", p:[["Kichik kosa",30],["O'rta kosa",40],["Katta kosa",55]]},
    {n:"Obi non", e:"🍞", r:"non", k:"non", p:[["Bo'lak (1/8)",20],["Chorak (1/4)",40],["Yarim (1/2)",80]]},
    {n:"Patir", e:"🥨", r:"patir", k:"non", p:[["Bo'lak",22],["Chorak",45],["Yarim",90]]},
    {n:"Moshkichiri", e:"🍚", r:"moshkichiri", k:"taom", p:[["Kichik",45],["O'rta",60],["Katta",80]]},
    {n:"Dimlama", e:"🥘", r:"dimlama", k:"taom", p:[["Kichik",25],["O'rta",35],["Katta",45]]},
    {n:"Shashlik", e:"🍢", r:"shashlik", k:"taom", p:[["1 six",2],["2 six",4],["3 six",6]]},
    {n:"Kartoshka pyure", e:"🥔", r:"kartoshka", k:"taom", p:[["Kichik",25],["O'rta",35],["Katta",50]]},
    {n:"Makaron", e:"🍝", r:"makaron", k:"taom", p:[["Kichik",40],["O'rta",60],["Katta",85]]},
    {n:"Choy + qand", e:"🍵", r:"choy", k:"ichimlik", p:[["1 dona qand",5],["2 dona qand",10],["3 dona qand",15]]},
    {n:"Kompot", e:"🧃", r:"kompot", k:"ichimlik", p:[["Piyola",15],["Kosa",25],["Katta",35]]},
    {n:"Olma", e:"🍎", r:"olma", k:"meva", p:[["Kichik",10],["O'rta",18],["Katta",25]]},
    {n:"Banan", e:"🍌", r:"banan", k:"meva", p:[["Yarim",12],["1 dona",25],["Katta",30]]},
    {n:"Uzum", e:"🍇", r:"uzum", k:"meva", p:[["Hovuch (100 g)",15],["150 g",25],["200 g",35]]},
    {n:"Tarvuz", e:"🍉", r:"tarvuz", k:"meva", p:[["1 bo'lak",15],["2 bo'lak",25],["3 bo'lak",35]]},
    {n:"Qovun", e:"🍈", r:"qovun", k:"meva", p:[["1 bo'lak",20],["2 bo'lak",30],["3 bo'lak",40]]},
    {n:"Shaftoli", e:"🍑", r:"shaftoli", k:"meva", p:[["Kichik",8],["O'rta",12],["Katta",18]]},
    {n:"Halva", e:"🍬", r:"holva", k:"shirinlik", p:[["Kichik bo'lak",15],["O'rta bo'lak",30],["Katta bo'lak",45]]},
    // Yangi mahsulotlar — qiymatlar shifokor tahlilidan o'tgan
    {n:"Anor", e:"🍒", r:"anor", k:"meva", p:[["Kichik",15],["O'rta",25],["Katta",35]]},
    {n:"Nok", e:"🍐", r:"nok", k:"meva", p:[["Kichik",14],["O'rta",20],["Katta",28]]},
    {n:"Qulupnay", e:"🍓", r:"qulupnay", k:"meva", p:[["Hovuch (100 g)",7],["150 g",10],["200 g",14]]},
    {n:"O'rik", e:"🍑", r:"orik", k:"meva", p:[["2 dona",8],["4 dona",15],["6 dona",23]]},
    {n:"Qatiq", e:"🥛", r:"qatiq", k:"sut", p:[["Yarim stakan",4],["1 stakan",8],["Katta stakan",12]]},
    {n:"Tvorog", e:"🥣", r:"tvorog", k:"sut", p:[["50 g",2],["100 g",3],["200 g",6]]},
    {n:"Pishloq", e:"🧀", r:"pishloq", k:"sut", p:[["1 bo'lak",0.5],["2 bo'lak",1],["4 bo'lak",2]]},
    {n:"Smetana", e:"🥄", r:"smetana", k:"sut", p:[["1 osh qoshiq",0.5],["2 osh qoshiq",1],["4 osh qoshiq",2]]},
    {n:"Muzqaymoq", e:"🍦", r:"muzqaymoq", k:"sut", p:[["Kichik",11],["O'rta",21],["Katta",32]]}
  ];

  // Taomlar bazasi turkumlari — chip-filter uchun ('hammasi' maxsus qiymat)
  var TURKUMLAR = [
    { id:'hammasi', tKey:'trk_hammasi' },
    { id:'taom', tKey:'trk_taom' },
    { id:'non', tKey:'trk_non' },
    { id:'ichimlik', tKey:'trk_ichimlik' },
    { id:'meva', tKey:'trk_meva' },
    { id:'sut', tKey:'trk_sut' },
    { id:'shirinlik', tKey:'trk_shirinlik' }
  ];
  var joriyTurkum = 'hammasi';

  var TAOM_RASM = {banan:"assets/img/taomlar/banan.webp",choy:"assets/img/taomlar/choy.webp",chuchvara:"assets/img/taomlar/chuchvara.webp",dimlama:"assets/img/taomlar/dimlama.webp",holva:"assets/img/taomlar/holva.webp",kartoshka:"assets/img/taomlar/kartoshka.webp",kompot:"assets/img/taomlar/kompot.webp",lagmon:"assets/img/taomlar/lagmon.webp",makaron:"assets/img/taomlar/makaron.webp",manti:"assets/img/taomlar/manti.webp",mastava:"assets/img/taomlar/mastava.webp",moshkichiri:"assets/img/taomlar/moshkichiri.webp",non:"assets/img/taomlar/non.webp",olma:"assets/img/taomlar/olma.webp",palov:"assets/img/taomlar/palov.webp",patir:"assets/img/taomlar/patir.webp",qovun:"assets/img/taomlar/qovun.webp",shaftoli:"assets/img/taomlar/shaftoli.webp",shashlik:"assets/img/taomlar/shashlik.webp",shorva:"assets/img/taomlar/shorva.webp",somsa:"assets/img/taomlar/somsa.webp",tarvuz:"assets/img/taomlar/tarvuz.webp",uzum:"assets/img/taomlar/uzum.webp",anor:"assets/img/taomlar/anor.webp",nok:"assets/img/taomlar/nok.webp",qulupnay:"assets/img/taomlar/qulupnay.webp",orik:"assets/img/taomlar/orik.webp",qatiq:"assets/img/taomlar/qatiq.webp",tvorog:"assets/img/taomlar/tvorog.webp",pishloq:"assets/img/taomlar/pishloq.webp",smetana:"assets/img/taomlar/smetana.webp",muzqaymoq:"assets/img/taomlar/muzqaymoq.webp"};
  ...
  uz: {
    ...
    bl_h: "Bilim bo'limi",
    bl_p: "Diabet haqida ishonchli, qisqa va amaliy ma'lumotlar",
    ...
    trk_hammasi: "Hammasi",
    trk_taom: "Taomlar",
    trk_non: "Non mahsulotlari",
    trk_ichimlik: "Ichimliklar",
    trk_meva: "Mevalar",
    trk_sut: "Sut mahsulotlari",
    trk_shirinlik: "Shirinliklar",
    tg_t: "Bizning Telegram kanalimiz",
    tg_s: "Yangiliklar va foydali maslahatlar uchun qo'shiling",
    avatar_aria: "Profil rasmini o'zgartirish",
    avatar_saqla_t: "Rasmni saqlash",
    avatar_bekor_t: "Bekor qilish",
    avatar_yuklanmoqda: "Yuklanmoqda…",
    avatar_saqlandi: "✓ Profil rasmi saqlandi",
    avatar_xato_tur: "Faqat JPG, PNG yoki WebP formatidagi rasm tanlang.",
    avatar_xato_hajm: "Rasm hajmi 5 MB dan oshmasligi kerak.",
    avatar_xato_yuklash: "Rasmni yuklab bo'lmadi. Qayta urining."
  },
  ru: {
    ...
    bl_h: "Раздел знаний",
    bl_p: "Статьи о диабете пока доступны только на узбекском языке",
    ...
    trk_hammasi: "Все",
    trk_taom: "Блюда",
    trk_non: "Хлебные изделия",
    trk_ichimlik: "Напитки",
    trk_meva: "Фрукты",
    trk_sut: "Молочные продукты",
    trk_shirinlik: "Сладости",
    tg_t: "Наш Telegram-канал",
    tg_s: "Подпишитесь, чтобы получать новости и полезные советы",
    avatar_aria: "Изменить фото профиля",
    avatar_saqla_t: "Сохранить фото",
    avatar_bekor_t: "Отмена",
    avatar_yuklanmoqda: "Загрузка…",
    avatar_saqlandi: "✓ Фото профиля сохранено",
    avatar_xato_tur: "Выберите изображение в формате JPG, PNG или WebP.",
    avatar_xato_hajm: "Размер изображения не должен превышать 5 МБ.",
    avatar_xato_yuklash: "Не удалось загрузить фото. Попробуйте ещё раз."
  },
  en: {
    ...
    bl_h: "Learn",
    bl_p: "Articles about diabetes are currently available in Uzbek only",
    ...
    trk_meva: "Fruits",
    trk_sut: "Dairy",
    trk_shirinlik: "Sweets",
    tg_t: "Our Telegram channel",
    tg_s: "Join us for updates and helpful tips",
    avatar_aria: "Change profile photo",
    avatar_saqla_t: "Save photo",
    avatar_bekor_t: "Cancel",
    avatar_yuklanmoqda: "Uploading…",
    avatar_saqlandi: "✓ Profile photo saved",
    avatar_xato_tur: "Please choose a JPG, PNG or WebP image.",
    avatar_xato_hajm: "The image must be smaller than 5 MB.",
    avatar_xato_yuklash: "Couldn't upload the photo. Please try again."
  }
  };

  var TAOM_TARJIMA = {
    ru: {"Osh (palov)":"Плов","Lag'mon":"Лагман","Mastava":"Мастава","Sho'rva":"Шурпа","Manti":"Манты","Somsa":"Самса","Chuchvara":"Чучвара","Obi non":"Лепёшка (оби нон)","Patir":"Патир","Moshkichiri":"Машкичири","Dimlama":"Димлама","Shashlik":"Шашлык","Kartoshka pyure":"Картофельное пюре","Makaron":"Макароны","Choy + qand":"Чай с сахаром","Kompot":"Компот","Olma":"Яблоко","Banan":"Банан","Uzum":"Виноград","Tarvuz":"Арбуз","Qovun":"Дыня","Shaftoli":"Персик","Halva":"Халва","Anor":"Гранат","Nok":"Груша","Qulupnay":"Клубника","O'rik":"Абрикос","Qatiq":"Катык","Tvorog":"Творог","Pishloq":"Сыр","Smetana":"Сметана","Muzqaymoq":"Мороженое"},
    en: {"Osh (palov)":"Pilaf (osh)","Lag'mon":"Lagman noodles","Mastava":"Mastava soup","Sho'rva":"Shurpa soup","Manti":"Manti dumplings","Somsa":"Samsa","Chuchvara":"Chuchvara dumplings","Obi non":"Flatbread (obi non)","Patir":"Patir bread","Moshkichiri":"Moshkichiri","Dimlama":"Dimlama stew","Shashlik":"Shashlik (kebab)","Kartoshka pyure":"Mashed potatoes","Makaron":"Pasta","Choy + qand":"Tea with sugar","Kompot":"Kompot","Olma":"Apple","Banan":"Banana","Uzum":"Grapes","Tarvuz":"Watermelon","Qovun":"Melon","Shaftoli":"Peach","Halva":"Halva","Anor":"Pomegranate","Nok":"Pear","Qulupnay":"Strawberries","O'rik":"Apricot","Qatiq":"Qatiq (drinking yogurt)","Tvorog":"Cottage cheese","Pishloq":"Cheese","Smetana":"Sour cream","Muzqaymoq":"Ice cream"}
  };

  var PORS_TARJIMA = {
    ru: {"Kichik kosa":"Малая пиала","O'rta kosa":"Средняя пиала","Katta kosa":"Большая пиала","Kichik":"Малая","O'rta":"Средняя","Katta":"Большая","2 dona":"2 шт.","4 dona":"4 шт.","6 dona":"6 шт.","1 dona":"1 шт.","3 dona":"3 шт.","Bo'lak (1/8)":"Кусок (1/8)","Chorak (1/4)":"Четверть (1/4)","Yarim (1/2)":"Половина (1/2)","Bo'lak":"Кусок","Chorak":"Четверть","Yarim":"Половина","1 six":"1 шампур","2 six":"2 шампура","3 six":"3 шампура","1 dona qand":"1 кусочек сахара","2 dona qand":"2 кусочка сахара","3 dona qand":"3 кусочка сахара","Piyola":"Пиала","Kosa":"Большая пиала","Hovuch (100 g)":"Горсть (100 г)","150 g":"150 г","200 g":"200 г","1 bo'lak":"1 ломтик","2 bo'lak":"2 ломтика","3 bo'lak":"3 ломтика","4 bo'lak":"4 ломтика","Kichik bo'lak":"Малый кусок","O'rta bo'lak":"Средний кусок","Katta bo'lak":"Большой кусок","Yarim stakan":"Полстакана","1 stakan":"1 стакан","Katta stakan":"Большой стакан","50 g":"50 г","100 g":"100 г","1 osh qoshiq":"1 ст. ложка","2 osh qoshiq":"2 ст. ложки","4 osh qoshiq":"4 ст. ложки"},
    en: {"Kichik kosa":"Small bowl","O'rta kosa":"Medium bowl","Katta kosa":"Large bowl","Kichik":"Small","O'rta":"Medium","Katta":"Large","2 dona":"2 pcs","4 dona":"4 pcs","6 dona":"6 pcs","1 dona":"1 pc","3 dona":"3 pcs","Bo'lak (1/8)":"Slice (1/8)","Chorak (1/4)":"Quarter (1/4)","Yarim (1/2)":"Half (1/2)","Bo'lak":"Piece","Chorak":"Quarter","Yarim":"Half","1 six":"1 skewer","2 six":"2 skewers","3 six":"3 skewers","1 dona qand":"1 sugar cube","2 dona qand":"2 sugar cubes","3 dona qand":"3 sugar cubes","Piyola":"Small cup","Kosa":"Bowl","Hovuch (100 g)":"Handful (100 g)","150 g":"150 g","200 g":"200 g","1 bo'lak":"1 slice","2 bo'lak":"2 slices","3 bo'lak":"3 slices","4 bo'lak":"4 slices","Kichik bo'lak":"Small piece","O'rta bo'lak":"Medium piece","Katta bo'lak":"Large piece","Yarim stakan":"Half glass","1 stakan":"1 glass","Katta stakan":"Large glass","50 g":"50 g","100 g":"100 g","1 osh qoshiq":"1 tbsp","2 osh qoshiq":"2 tbsp","4 osh qoshiq":"4 tbsp"}
  };
  ...
  function tilQoy(t){
    ...
    var avatarTugmaEl = el('authAvatarTugma');
    if (avatarTugmaEl) avatarTugmaEl.setAttribute('aria-label', M('avatar_aria'));
  ...
  // Turkum chiplarini chizish (taomlar modalidagi filter qatori)
  function turkumChiz(){
    var qator = el('turkumQator');
    if (!qator) return;
    qator.innerHTML = TURKUMLAR.map(function(tk){
      return "<button class='turkum-chip" + (tk.id === joriyTurkum ? " faol" : "") + "' data-turkum='" + tk.id + "'>" + M(tk.tKey) + "</button>";
    }).join("");
  }

  // Taom kartalarini chizish — joriy turkum bo'yicha filtrlanadi,
  // data-i esa doim TAOMLAR massividagi asl indeksni saqlaydi (savat shunga tayanadi)
  function gridChiz(){
    turkumChiz();
    taomGrid.innerHTML = TAOMLAR.map(function(t, i){ return { t: t, i: i }; })
      .filter(function(o){ return joriyTurkum === 'hammasi' || o.t.k === joriyTurkum; })
      .map(function(o){
        var t = o.t, i = o.i;
  ...
  // Turkum chipi bosilganda — filtr almashadi, grid qayta chiziladi
  var turkumQator = el('turkumQator');
  if (turkumQator){
    turkumQator.addEventListener('click', function(ev){
      var chip = ev.target.closest('.turkum-chip');
      if (!chip) return;
      joriyTurkum = chip.getAttribute('data-turkum');
      gridChiz();
    });
  }
  ...
  function boshPanelChiz(){
    ...
    if (mk){
      mk.innerHTML = '<img src="' + rasm + '" alt="" fetchpriority="low" decoding="async">' +
  ...
  // ========== Bilim bo'limi: maqolalar ==========
  var BILIM_IKON = {
    ogohlantirish: '<path d="M12 3 L22 20 L2 20 Z"/><line x1="12" y1="9" x2="12" y2="14"/><circle cx="12" cy="17" r=".6" fill="currentColor"/>',
    yuqori: '<polyline points="3,17 9,11 13,15 21,6"/><polyline points="15,6 21,6 21,12"/>',
    oyparcha: '<path d="M16 4a8 8 0 1 0 0 16 7 7 0 0 1 0-16Z"/><path d="M19 3l.6 1.4L21 5l-1.4.6L19 7l-.6-1.4L17 5l1.4-.6Z" fill="currentColor" stroke="none"/>',
    talabalik: '<path d="M2 9l10-4 10 4-10 4-10-4Z"/><path d="M6 11v5c0 1.5 2.7 3 6 3s6-1.5 6-3v-5"/><path d="M22 9v6"/>',
    idish: '<path d="M7 3v7a2 2 0 0 0 4 0V3"/><path d="M9 10v11"/><path d="M17 3c-1.5 0-2.5 2-2.5 5s1 5 2.5 5v8"/>',
    kolba: '<path d="M10 2h4"/><path d="M11 2v5.5L6.5 14a4 4 0 0 0 3 6.5h5a4 4 0 0 0 3-6.5L13 7.5V2"/><line x1="7.5" y1="16" x2="16.5" y2="16"/>',
    yugurish: '<circle cx="14.5" cy="4.5" r="1.8" fill="currentColor" stroke="none"/><path d="M6 20l3.5-5 2.5 1.5 1-4"/><path d="M9.5 15L7 10.5 11 9l2 2.5 4-1"/><path d="M13 11.5L15.5 14l3.5 1"/>',
    termometr: '<path d="M12 14.5V4a2 2 0 0 0-4 0v10.5a4 4 0 1 0 4 0Z"/><line x1="10" y1="7" x2="12" y2="7"/><line x1="10" y1="10" x2="12" y2="10"/>'
  };

  function bilimSvg(nom){
    return '<svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">' + BILIM_IKON[nom] + '</svg>';
  }

  var BILIM_MAQOLALAR = [
    {
      id: 'gipo', ikon: 'ogohlantirish', toifa: "Xavfsizlik",
      sarlavha: "Gipoglikemiya — qand pasayganda nima qilish kerak",
      qisqa: "Qon qandi past tushganda darhol bilish va to'g'ri harakat qilish muhim ahamiyatga ega.",
      matn: '<p>Gipoglikemiya — qon qandining 3.9 mmol/L dan pastga tushishi. Bu holatni tezda tanish va to\'g\'ri harakat qilish sizning xavfsizligingiz uchun juda muhim.</p>' +
        '<h4>Alomatlari</h4><ul><li>Titrash, terlash</li><li>Kuchli ochlik hissi</li><li>Bosh aylanishi, asabiylashish</li><li>Ko\'rish xiraligi, chalkashlik</li></ul>' +
        '<h4>Sabablari</h4><ul><li>Ovqatni o\'tkazib yuborish yoki kechiktirish</li><li>Ortiqcha insulin dozasi</li><li>Kutilmagan yoki intensiv jismoniy faollik</li><li>Alkogol iste\'moli</li></ul>' +
        '<h4>«15-15 qoidasi»</h4><ul><li>15 gramm tez uglevod qabul qiling (3-4 dona shakar, yarim stakan meva sharbati yoki glyukoza tabletkasi)</li><li>15 daqiqa kuting</li><li>Qandni qayta o\'lchang — hali past bo\'lsa, takrorlang</li></ul>' +
        '<div class="bilim-muhim"><p>Agar odam hushidan ketsa — og\'zidan hech narsa berilmasin, darhol tez tibbiy yordam chaqiring.</p></div>'
    },
    {
      id: 'giper', ikon: 'yuqori', toifa: "Xavfsizlik",
      sarlavha: "Giperglikemiya — qand ko'tarilganda bilishingiz kerak bo'lganlar",
      qisqa: "Qon qandi uzoq vaqt yuqori bo'lishi asoratlarga olib kelishi mumkin — uni qanday tanish mumkin.",
      matn: '<p>Giperglikemiya — qon qandining uzoq vaqt yuqori (ovqatdan keyin 10 mmol/L dan, och qoringa 7.2 mmol/L dan yuqori) bo\'lib qolishi.</p>' +
        '<h4>Alomatlari</h4><ul><li>Kuchli chanqash</li><li>Tez-tez siyish</li><li>Charchoq, holsizlik</li><li>Ko\'rish xiraligi, bosh og\'rig\'i</li></ul>' +
        '<h4>Sabablari</h4><ul><li>Yetarli insulin olinmagan</li><li>Kasallik yoki stress</li><li>Kutilganidan ko\'p uglevod iste\'mol qilingan</li><li>Jismoniy faollik yetishmasligi</li></ul>' +
        '<h4>Nima qilish kerak</h4><ul><li>Suyuqlik ko\'p iching</li><li>Shifokor ko\'rsatmasiga muvofiq korreksiya dozasini oling</li><li>1-tur diabetda ketonlarni tekshiring</li></ul>' +
        '<div class="bilim-muhim"><p>Qusish, nafas olish qiyinlashishi yoki ketonlar yuqori aniqlanishi — darhol tibbiy yordamga murojaat qiling.</p></div>'
    },
    {
      id: 'ramazon', ikon: 'oyparcha', toifa: "Hayot tarzi",
      sarlavha: "Ramazonda ro'za tutish — diabetiklar uchun qo'llanma",
      qisqa: "Ro'za tutish diniy va shaxsiy tanlov — lekin bu qaror albatta shifokor bilan muhokama qilinishi kerak.",
      matn: '<div class="bilim-muhim"><p>Ro\'za tutish qarori FAQAT endokrinolog bilan maslahatlashib qabul qilinishi kerak. Islom dini og\'ir kasal insonlarni ro\'zadan ozod qiladi — bu tanlov, majburiyat emas.</p></div>' +
        '<p>Agar shifokoringiz ruxsat bersa, insulin dozasi va vaqti saharlik va iftor vaqtiga moslab qayta ko\'rib chiqilishi kerak.</p>' +
        '<h4>Iftorda</h4><ul><li>Sekin, kichik porsiyalar bilan boshlang (masalan, xurmo va suv)</li><li>So\'ngra asosiy ovqatga o\'ting, shoshilmang</li></ul>' +
        '<h4>Saharlikda</h4><ul><li>Sekin hazm bo\'ladigan, murakkab uglevodlarga boy ovqatlar afzal</li><li>Yetarli suyuqlik iching</li></ul>' +
        '<h4>Kun davomida</h4><ul><li>Qandni bir necha marta tekshirish shart — ro\'za bu tekshiruvni bekor qilmaydi</li><li>Tekshirish ro\'zani buzmaydi</li></ul>' +
        '<div class="bilim-muhim"><p>Agar qand 3.9 mmol/L dan past yoki 16.7 mmol/L dan yuqori bo\'lsa, ro\'zani darhol buzish kerak — bu diniy jihatdan ham ruxsat etilgan.</p></div>'
    },
    {
      id: 'maktab', ikon: 'talabalik', toifa: "Bolalar",
      sarlavha: "Diabet maktabi — bolangizga qanday yordam berish mumkin",
      qisqa: "Farzandingizda 1-tur diabet aniqlanishi qo'rqinchli bo'lishi mumkin, lekin to'g'ri bilim bilan u to'liq oddiy hayot kechirishi mumkin.",
      matn: '<p>Diagnoz qo\'rqinchli tuyulishi tabiiy holat, lekin diabet bolaning to\'liq va faol hayot kechirishiga to\'sqinlik qilmasligi kerak.</p>' +
        '<h4>Maktab bilan aloqa</h4><ul><li>O\'qituvchi va hamshiraga bolaning holatini tushuntiring</li><li>Gipoglikemiya alomatlarini qanday tanishni ko\'rsating</li></ul>' +
        '<h4>Maktabda kerakli narsalar</h4><ul><li>Glyukometr</li><li>Tez uglevod manbai (shakar yoki sharbat)</li><li>Zarur bo\'lsa, insulin</li><li>Favqulodda aloqa raqami</li></ul>' +
        '<h4>Mustaqillikka o\'rgatish</h4><p>Bolaning yoshiga qarab, asta-sekin o\'z holatini kuzatishga va oddiy qarorlar qabul qilishga o\'rgating.</p>' +
        '<h4>Do\'stlar va sport</h4><p>Diabetni yashirish shart emas — ochiq tushuntirish ko\'pincha yordam beradi. Diabet sport bilan shug\'ullanishga to\'sqinlik qilmaydi, faqat oldindan biroz rejalashtirish kerak.</p>'
    },
    {
      id: 'ovqat', ikon: 'idish', toifa: "Ovqatlanish",
      sarlavha: "Uglevodlarni hisoblash — boshlang'ich qo'llanma",
      qisqa: "Har bir taomdagi uglevod miqdorini bilish — to'g'ri insulin dozasini hisoblashning kaliti.",
      matn: '<p>Non, guruch, makaron, meva va shirinliklar — bularning barchasi qon qandiga bevosita va tezroq ta\'sir qiladi.</p>' +
        '<h4>Oqsil va yog\' haqida</h4><p>Ular qandga sekinroq ta\'sir qiladi, lekin katta miqdorda iste\'mol qilinganda ham hisobga olinishi kerak.</p>' +
        '<h4>Porsiyani nazorat qilish</h4><ul><li>Ko\'z bilan taxminiy baholash vaqt o\'tishi bilan osonlashadi</li><li>Boshida o\'lchov qoshiq yoki tarozidan foydalanish foydali</li></ul>' +
        '<h4>Doza\'dagi taomlar bazasi</h4><p>Ilovamizdagi Taomlar bo\'limi mahalliy taomlar uchun tayyor uglevod qiymatlarini beradi — bu boshlang\'ich hisob-kitobni osonlashtiradi.</p>' +
        '<h4>Qo\'shimcha maslahatlar</h4><ul><li>Suvni ko\'p iching</li><li>Tolaga boy sabzavotlar umumiy qand nazoratiga yordam beradi</li></ul>'
    },
    {
      id: 'saqlash', ikon: 'kolba', toifa: "Amaliy maslahatlar",
      sarlavha: "Insulinni qanday saqlash kerak",
      qisqa: "Noto'g'ri saqlangan insulin o'z ta'sirini yo'qotishi mumkin — buni bilish sog'lig'ingiz uchun muhim.",
      matn: '<h4>Ochilmagan insulin</h4><p>Muzlatgichda, 2–8°C haroratda saqlanadi. Muzlatilishiga aslo yo\'l qo\'ymang.</p>' +
        '<h4>Ochilgan (ishlatilayotgan) insulin</h4><p>Xona haroratida (25°C gacha) saqlash mumkin, odatda 28–30 kun ichida ishlatilishi kerak — aniq muddat quti yoki insert\'da ko\'rsatilgan.</p>' +
        '<h4>Nimalardan saqlanish kerak</h4><ul><li>To\'g\'ridan-to\'g\'ri quyosh nuri</li><li>Issiq joyda qoldirish (masalan, avtomobil ichida)</li><li>Muzlab qolish</li></ul>' +
        '<div class="bilim-muhim"><p>Muzlab qolgan yoki haddan tashqari qizigan insulinni ishlatmang — tashqi ko\'rinishi normal bo\'lsa ham.</p></div>' +
        '<h4>Sayohatda</h4><p>Sovutgich sumka (izoterma paket) ishlatish tavsiya etiladi. Har safar ishlatishdan oldin rangi va tiniqligini tekshiring.</p>'
    },
    {
      id: 'sport', ikon: 'yugurish', toifa: "Hayot tarzi",
      sarlavha: "Sport va jismoniy faollik — diabetga qanday ta'sir qiladi",
      qisqa: "Muntazam jismoniy faollik qand nazoratini yaxshilaydi, lekin to'g'ri tayyorgarlikni talab qiladi.",
      matn: '<p>Jismoniy mashqlar insulin sezuvchanligini oshiradi va qandni tabiiy ravishda pasaytirishga yordam beradi.</p>' +
        '<h4>Mashqdan oldin</h4><p>Qandingizni tekshiring — agar 5.5 mmol/L dan past bo\'lsa, kichik gazak yeb oling.</p>' +
        '<h4>Mashq paytida va keyin</h4><p>Past qand xavfi mashqdan keyin bir necha soatgacha davom etishi mumkin, shuning uchun keyin ham tekshirish tavsiya etiladi. O\'zingiz bilan doim tez uglevod manbai olib yuring.</p>' +
        '<h4>Uzoq yoki intensiv mashqlar</h4><p>Bunday holatlarda insulin dozasini shifokor bilan maslahatlashib moslashtirish kerak bo\'lishi mumkin.</p>' +
        '<h4>Qayerdan boshlash</h4><p>Istalgan faollik turi foydali — oddiy piyoda yurish ham sezilarli natija beradi.</p>'
    },
    {
      id: 'kasal', ikon: 'termometr', toifa: "Xavfsizlik",
      sarlavha: "Kasal bo'lganda qandni qanday boshqarish kerak",
      qisqa: "Shamollash yoki boshqa kasallik davrida qand ko'rsatkichlari kutilmagan tarzda o'zgarishi mumkin.",
      matn: '<p>Har qanday kasallik, hatto oddiy shamollash ham, stress gormonlari tufayli qandni oshirishi mumkin.</p>' +
        '<div class="bilim-muhim"><p>Insulinni HECH QACHON to\'xtatmang, hatto ovqat yeyolmasangiz ham — shifokoringiz boshqacha ko\'rsatma bermagan bo\'lsa.</p></div>' +
        '<h4>Kasallik davrida</h4><ul><li>Qandni odatdagidan tez-tez, har 2–4 soatda tekshiring</li><li>1-tur diabetda ketonlarni alohida tekshiring, ayniqsa qand yuqori bo\'lsa</li><li>Suyuqlikni kichik yutumlar bilan bo\'lsa ham davom ettiring</li></ul>' +
        '<h4>Qachon shifokorga murojaat qilish kerak</h4><ul><li>Qusish 4 soatdan ortiq davom etsa</li><li>Ketonlar yuqori aniqlansa</li><li>Qand doimiy 15 mmol/L dan yuqori yoki past bo\'lsa</li></ul>'
    }
  ];

  function bilimRoyxatChiz(){
    var orama = el('bilimRoyxat');
    if (!orama) return;
    orama.innerHTML = BILIM_MAQOLALAR.map(function(m){
      return '<button class="bilim-karta" data-id="' + m.id + '">' +
        '<span class="bilim-ico">' + bilimSvg(m.ikon) + '</span>' +
        '<span class="bilim-matn-blok">' +
          '<span class="bilim-eyebrow">' + m.toifa + '</span>' +
          '<h3>' + m.sarlavha + '</h3>' +
          '<p>' + m.qisqa + '</p>' +
        '</span>' +
        '<span class="bilim-oq">›</span>' +
      '</button>';
    }).join('');
    var tugmalar = orama.querySelectorAll('.bilim-karta');
    for (var i = 0; i < tugmalar.length; i++){
      tugmalar[i].addEventListener('click', function(){
        bilimMaqolaOch(this.getAttribute('data-id'));
      });
    }
  }

  var bilimModalFon = el('bilimModalFon');
  function bilimMaqolaOch(id){
    var m = null;
    for (var i = 0; i < BILIM_MAQOLALAR.length; i++){
      if (BILIM_MAQOLALAR[i].id === id){ m = BILIM_MAQOLALAR[i]; break; }
    }
    if (!m) return;
    el('bilimOqishOrama').innerHTML =
      '<div class="bilim-o-bosh">' +
        '<div class="bilim-o-ico">' + bilimSvg(m.ikon) + '</div>' +
        '<span class="bilim-eyebrow">' + m.toifa + '</span>' +
        '<h2 id="bilim-o-sarlavha">' + m.sarlavha + '</h2>' +
      '</div>' +
      '<div class="bilim-o-ich">' + m.matn + '</div>';
    bilimModalFon.classList.add('ochiq');
    document.body.style.overflow = 'hidden';
  }
  function bilimMaqolaYop(){
    bilimModalFon.classList.remove('ochiq');
    document.body.style.overflow = '';
  }
  el('bilimModalYop').addEventListener('click', bilimMaqolaYop);
  bilimModalFon.addEventListener('click', function(ev){
    if (ev.target === bilimModalFon) bilimMaqolaYop();
  });
  document.addEventListener('keydown', function(ev){
    if (ev.key === 'Escape' && bilimModalFon.classList.contains('ochiq')) bilimMaqolaYop();
  });
  bilimRoyxatChiz();
  ...
  // Profil rasmi holati: Firestore'dagi yuklangan rasm URL'i (bo'lsa)
  var joriyAvatarUrl = '';

  // Avatarni chizish: URL bo'lsa rasm, bo'lmasa ismning bosh harfi
  function avatarChiz(url, nom){
    var av = el('authAvatar');
    if (url){
      av.innerHTML = "<img src='" + url + "' alt='' loading='lazy' decoding='async'>";
    } else {
  ...
  function profilKorsat(user){
    ...
    // Ustuvorlik: yuklangan rasm (Firestore) > provayder rasmi (Google) > bosh harf
    if (!joriyAvatarUrl && user.photoURL) joriyAvatarUrl = user.photoURL;
    avatarChiz(joriyAvatarUrl, nom);
  ...
  if (!FIREBASE_TAYYOR || typeof firebase === 'undefined' || !fsDb){
    ...
    // ---------- Profil rasmi (avatar) yuklash — Firebase Storage ----------
    var AVATAR_MAX_HAJM = 5 * 1024 * 1024; // 5 MB
    var AVATAR_TURLAR = ['image/jpeg', 'image/png', 'image/webp'];
    var avatarFayl = el('avatarFayl');
    var tanlanganAvatar = null;   // oldindan ko'rish holatidagi fayl
    var avatarObjUrl = null;      // preview uchun vaqtinchalik obyekt-URL

    function avatarXabar(matn, xato){
      var x = el('avatarXabar');
      if (!matn){ x.hidden = true; return; }
      x.textContent = matn;
      x.className = 'auth-xabar ' + (xato ? 'xato' : 'ok');
      x.hidden = false;
    }

    function avatarPreviewTozalash(){
      if (avatarObjUrl){ try { URL.revokeObjectURL(avatarObjUrl); } catch(e){} avatarObjUrl = null; }
      tanlanganAvatar = null;
      avatarFayl.value = '';
      el('avatarAmallar').hidden = true;
    }

    el('authAvatarTugma').addEventListener('click', function(){
      if (!joriyFoydalanuvchi) return;
      avatarFayl.click();
    });

    avatarFayl.addEventListener('change', function(){
      var f = this.files && this.files[0];
      if (!f) return;
      if (AVATAR_TURLAR.indexOf(f.type) === -1){ avatarXabar(M('avatar_xato_tur'), true); this.value = ''; return; }
      if (f.size > AVATAR_MAX_HAJM){ avatarXabar(M('avatar_xato_hajm'), true); this.value = ''; return; }
      avatarXabar('');
      if (avatarObjUrl){ try { URL.revokeObjectURL(avatarObjUrl); } catch(e){} }
      tanlanganAvatar = f;
      avatarObjUrl = URL.createObjectURL(f);
      avatarChiz(avatarObjUrl);
      el('avatarAmallar').hidden = false;
    });

    el('avatarBekor').addEventListener('click', function(){
      avatarPreviewTozalash();
      avatarXabar('');
      var nom = (joriyFoydalanuvchi && joriyFoydalanuvchi.displayName) || M('auth_nomsiz');
      avatarChiz(joriyAvatarUrl, nom);
    });

    el('avatarSaqla').addEventListener('click', function(){
      if (!tanlanganAvatar || !joriyFoydalanuvchi || !firebase.storage) return;
      var btn = this, user = joriyFoydalanuvchi, fayl = tanlanganAvatar;
      btn.disabled = true;
      btn.textContent = M('avatar_yuklanmoqda');
      var ref = firebase.storage().ref('avatars/' + user.uid + '/profil');
      ref.put(fayl, { contentType: fayl.type }).then(function(snap){
        return snap.ref.getDownloadURL();
      }).then(function(url){
        // URL Firestore'dagi foydalanuvchi hujjatida saqlanadi —
        // sahifa yangilanganda bulutdanYukla() orqali qayta tiklanadi
        return fsDb.collection('users').doc(user.uid).set({ photoURL: url }, { merge: true }).then(function(){
          joriyAvatarUrl = url;
          avatarPreviewTozalash();
          avatarChiz(url);
          avatarXabar(M('avatar_saqlandi'), false);
        });
      }).catch(function(err){
        console.error('Avatar yuklanmadi:', err);
        avatarXabar(M('avatar_xato_yuklash'), true);
      }).finally(function(){
        btn.disabled = false;
        btn.textContent = M('avatar_saqla_t');
      });
    });
    ...
    function bulutdanYukla(uid){
      ...
      fsDb.collection('users').doc(uid).get().then(function(doc){
        ...
        var ma = doc.data();
        if (ma.photoURL){
          joriyAvatarUrl = ma.photoURL;
          avatarChiz(joriyAvatarUrl);
        }
        if (ma.settings){
          var s = ma.settings;
