(function(){
  ...
  function viewOchish(nom){
    ...
    var yangiEl = nom === 'bosh' ? el('viewBosh') : (nom === 'kundalik' ? el('viewKundalik') : el('viewBilim'));
  ...
  function profilKorsat(user){
    ...
    yopRoyxatTugma.classList.add('yashirin');
  }
  ...
  if (!FIREBASE_TAYYOR || typeof firebase === 'undefined' || !fsDb){
    ...
    firebase.auth().onAuthStateChanged(function(user){
      ...
      if (!user){
        ...
        yopRoyxatTugma.classList.remove('yashirin');
        boshPanelChiz();
        kundalikChiz();
        return;
      }
